...
import im from './radio.png'
import imm from './radio.png'
      ...
      <div className="container-fluid nav_bg">
        <div className="row">
          <div className="col-11 mx-auto">
            ...
            <NavLink to="/home"> <Navbar.Brand to="/" className="home"><img className="icon" src={im} /> Radio 104</Navbar.Brand></NavLink>
              ...
              <Navbar.Collapse id="navbarScroll">
                ...
                >
                  ...
                  <NavLink activeClassName="pga" className="nav-link" exact to="/courses">| Merchandise  |</NavLink>
                  <NavLink activeClassName="pga" className="nav-link" exact to="/player">| Stream LIVE  |</NavLink>
